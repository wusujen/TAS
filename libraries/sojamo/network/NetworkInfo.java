...
public class NetworkInfo {
  ...
  public static String lan() {
    SNetwork.printProcess("NetInfo.checkNetworkStatus : ", getHostAddress());
  ...
  public static String wan() {
    ...
    SNetwork.printProcess("NetInfo.checkNetworkStatus",
                        "Checking internet  connection ...");
    try {
      u = new URL(URLstring);
    }
    catch (MalformedURLException e) {
      SNetwork.printError("NetInfo.checkNetworkStatus", "Bad URL "
                        + URLstring + " " + e);
    }
    ...
    try {
      ...
      SNetwork.printError("NetInfo.checkNetworkStatus",
