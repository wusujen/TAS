 ...
 * @invisible
 */
public class CStringUtils extends Object {

	/**
	 * Protected because this class does only contain static methods.
	 */
	protected CStringUtils() {
	}
	...
	public static String middle(String source, String start, String end) {
		String one = CStringUtils.right(source, start);
		return CStringUtils.leftBack(one, end);
	}
	...
	public static String replace(String source, String[] searchFor,
		...
		for (int i = 0; i < searchFor.length; i++) {
			CStringUtils.replace(source, searchFor[i], replaceWith);
		}
		return source;
	}
	...
	public static Vector explode(String[] source, int[] lengths) {
		...
		for (int i = 0; i < source.length; i++) {
			v.addElement(CStringUtils.explode(source[i], lengths));
		}
		return v;
	}
	...
	public static String[] explode(String source) {
		return CStringUtils.explode(source, " ");
	}
	...
	public static String remove(String source, char searchFor) {
		...
		return CStringUtils.remove(source, s);
	}
	...
	public static String remove(String source, String searchFor) {
		...
		return CStringUtils.replace(source, searchFor, "");
	}
	...
	public static String leftJustify(String source, int length) {
		...
		return CStringUtils.spaces(length - source.length()) + source;
	}
	...
	public static String rightJustify(String source, int length) {
		...
		return source + CStringUtils.spaces(length - source.length());
	}
	...
	public static String centerJustify(String source, int length) {
		...
		return CStringUtils.spaces(leftLength) + source
				+ CStringUtils.spaces(rightLength);
	}
	...
	public static String switchCase(String source) {
		...
		for (int i = 0; i < sourceArray.length; i++) {
			result.append(CStringUtils.switchCase(sourceArray[i]));
		}
		return result.toString();
	}
