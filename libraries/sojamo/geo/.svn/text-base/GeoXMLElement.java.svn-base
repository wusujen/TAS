...
public class GeoXMLElement {
     ...
     *         XMLElement(Hashtable, boolean)
     */
    public GeoXMLElement(Hashtable entities) {
     ...
     *         XMLElement(Hashtable, boolean)
     */
    public GeoXMLElement(boolean skipLeadingWhitespace) {
     ...
     */
    protected GeoXMLElement(Hashtable entities,
                         boolean skipLeadingWhitespace,
     ...
     */
    public void addChild(GeoXMLElement child) {
     ...
     */
    public void parseFromReader(Reader reader) throws IOException, GeoXMLParseException {
    ...
    public void parseFromReader(Reader reader,
                                int startingLineNr) throws IOException, GeoXMLParseException {
     ...
     */
    public void parseString(String string) throws GeoXMLParseException {
        try {
    ...
    public void parseString(String string,
                            int offset) throws GeoXMLParseException {
    ...
    public void parseString(String string,
                            int offset,
                            int end) throws GeoXMLParseException {
    ...
    public void parseString(String string,
                            int offset,
                            int end,
                            int startingLineNr) throws GeoXMLParseException {
     ...
     * @see nanoxml.XMLElement#getChildren()
     */
    public void removeChild(GeoXMLElement child) {
     ...
     */
    protected GeoXMLElement createAnotherElement() {
        return new GeoXMLElement(this.entities,
    ...
    public void write(Writer writer) throws IOException {
        ...
        if ( (this.contents != null) && (this.contents.length() > 0)) {
            ...
            while (myEnum.hasMoreElements()) {
                GeoXMLElement child = (GeoXMLElement) myEnum.nextElement();
                child.write(writer);
            }
            writer.write('<');
            writer.write('/');
     ...
     * </ul></dd></dl>
     */
    protected void scanElement(GeoXMLElement elt) throws IOException {
        ...
        if (buf.length() == 0) {
            while (ch != '/') {
                if (ch == '!') {
                    ...
                    this.unreadChar(ch);
                    GeoXMLElement child = this.createAnotherElement();
     ...
     * </ul></dd></dl>
     */
    protected GeoXMLParseException invalidValueSet(String name) {
        String msg = "Invalid value set (entity name = \"" + name + "\")";
        return new GeoXMLParseException(this.getName(), this.parserLineNr, msg);
    }
     ...
     * </ul></dd></dl>
     */
    protected GeoXMLParseException invalidValue(String name,
                                             String value) {
     ...
     * reached.
     */
    protected GeoXMLParseException unexpectedEndOfData() {
     ...
     * </ul></dd></dl>
     */
    protected GeoXMLParseException syntaxError(String context) {
     ...
     * </ul></dd></dl>
     */
    protected GeoXMLParseException expectedInput(String charSet) {
     ...
     * </ul></dd></dl>
     */
    protected GeoXMLParseException unknownEntity(String name) {
